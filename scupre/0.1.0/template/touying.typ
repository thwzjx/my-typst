...
#show: university-theme.with(
  ...
  config-colors(
  primary: rgb("#5e2626"),
  primary-light: rgb("#3f2d1d"),
  secondary: rgb("#a3514f"),
  neutral-lightest: rgb("#fbfbfb"),
  neutral-dark: rgb("#09191c"),
  neutral-darkest: rgb("#000000"),
  tertiary: rgb("#9b1313"),
)
)

#show: touying-set-config.with(config-common.with(handout: true))
